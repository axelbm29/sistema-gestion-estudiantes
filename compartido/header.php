...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/gestion-estudiantes/assets/css/style.css" />
  ...
  <div class="container-scroller">
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex align-items-center">
        <a class="navbar-brand brand-logo ml-auto text-right" href="http://localhost/gestion-estudiantes/dashboard.php">
          <img src="http://localhost/gestion-estudiantes/assets/images/logo.png" alt="logo" />
        </a>
        <a class="navbar-brand brand-logo-mini" href="http://localhost/gestion-estudiantes/dashboard.php"><img
