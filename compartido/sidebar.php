<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav" style="margin-top: 15px;">
    <li class="nav-item">
      <a class="nav-link" href="http://localhost/gestion-estudiantes/dashboard.php">
        ...
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            <a class="nav-link" style="color:white;"
              href="http://localhost/gestion-estudiantes/moduloCicloAcademico/add-periodo.php">
              <i class="fas fa-plus-circle mr-3"></i> Agregar Periodo Academico
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" style="color:white;"
              href="http://localhost/gestion-estudiantes/moduloCicloAcademico/manage-periodo.php">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic1">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            <a class="nav-link" style="color:white;"
              href="http://localhost/gestion-estudiantes/moduloEstudiante/add-students.php">
              <i class="fas fa-user-plus mr-3"></i> Agregar Estudiante
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" style="color:white;"
              href="http://localhost/gestion-estudiantes/moduloEstudiante/manage-students.php">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="at">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            <a class="nav-link" style="color:white;"
              href="http://localhost/gestion-estudiantes/moduloAsistencia/asistencia.php">
              <i class="fas fa-calendar-check mr-3"></i> Registrar Asistencia
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" style="color:white;"
              href="http://localhost/gestion-estudiantes/moduloAsistencia/show-asistencia.php">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="auth">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            <a class="nav-link" style="color:white;"
              href="http://localhost/gestion-estudiantes/moduloDocente/add-docente.php">
              <i class="fas fa-user-plus mr-3"></i> Agregar Docente
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" style="color:white;"
              href="http://localhost/gestion-estudiantes/moduloDocente/manage-docente.php">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="auth1">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            <a class="nav-link" style="color:white;"
              href="http://localhost/gestion-estudiantes/moduloNotas/add-notas.php">
              <i class="fas fa-plus-circle mr-3"></i> Agregar Notas
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" style="color:white;"
              href="http://localhost/gestion-estudiantes/moduloNotas/manage-notas.php">
